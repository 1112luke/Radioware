...
if __name__ == "__main__":
        ...
        fs = 7500000.0	       # maximum output sampling rate sustainable for pluto streaming: 2750000 (Hz), for m2k streaming: 750000 (Hz) 
        ...
        Mode = 0               #Default is not running any mode
        ...
        scheme = input("Please enter 'OOK' or 'QPSK' for the modulation scheme: ")
        ## scheme = "QPSK"

        #Specify the pulse shape ('rect' or 'rc')
        pulse_shape = input("Please enter 'rect' or 'rc' for the pulse shape: ")
        
        #If raised cosine, enter the roll off factor 'alpha'
        alpha = float(0) # setting a default value as to include the case of rectangular pulse shape
        if (pulse_shape == 'rc'):
            alpha = float(input("Please enter the desired value of roll-off factor b/w 0 and 1: "))
        ...
        time.sleep(1.0)
        input("TX device initialized, press Enter to start the transmission!")
        ...
        while(Mode == 1 or Mode == 2 or Mode == 4):
                ...
                #Specify the pulse shape ('rect' or 'rrc' or 'rc')
                ## pulse_shape = 'rc'
                baseband = pulse_shaping.pulse_shaping(baseband_symbols, M, fs, pulse_shape, alpha, 8)
