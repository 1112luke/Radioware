...
if __name__ == "__main__":
        ...
        ftuned = 0 #not really tuning the PLL for baseband wired comm
                
        #Initialize the transmiter device
        aout, spi_desc, sdr = HAL.setup_tx_device_control(device, same_machine, None, tx_gain, fs)
        ...
        while(Mode == 1 or Mode == 2 or Mode == 4):
                ...
                #use rectangular pulse for baseband wired lab
