...
def setup_rx_device_control(device, same_machine, ftuned, fs_in, total_samples):
        ...
        if(device == 'm2k'):
                ...
                if(ftuned != None):
                    # setup SPI
                    m2k_spi_init = libm2k.m2k_spi_init()
                    m2k_spi_init.clock = 1 # SCLK for HMC833
                    ##    digital.setOutputMode(1,1) #open drain: 0
                    m2k_spi_init.mosi = 2  # SDI for HMC833
                    m2k_spi_init.miso = 3  # SDO
                    m2k_spi_init.bit_numbering = libm2k.MSB
