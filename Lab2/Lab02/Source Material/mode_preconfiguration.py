...
def tx_mode_preconfig(Mode, R, segment_size, N, b, test_packet_num):
        ...
        if(Mode == 1):
                ...
                os.system('start /b ffmpeg -loglevel panic -f dshow -i video="Integrated RGB Camera" -b:v 90k -minrate 80k -maxrate 100k -vf scale=80:45 -r 8 -bufsize 3000k -flush_packets 0 udp://127.0.0.1:5010?pkt_size='+str(l)+'/stream.ts')
